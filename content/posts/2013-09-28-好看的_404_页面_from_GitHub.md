...
date: 2013-09-28T17:04:00+08:00
published: true
slug: hao-kan-de-404-ye-mian-from-github
tags: ['网站']
cover_image: ./images/Page_not_found_·_GitHub.png
canonical_url: false
description: "对于网站来说，其实404页面是挺重要的，也许你并不经常访问得到，但是404是为了你的访客和搜索引擎而存在的，如果404也做好的话，对于搜索引擎来说是很有好的，但是好看的404设计挺难的，感谢github，要不是github把404页面的代码都公开，真的无法把它给扒下来，也许有人认为我的行为是不道德的，但是我说开源才是进步。这里分为emlog和wordpress两种平台来介绍。"
---
...
![github的404页面](./images/Page_not_found_·_GitHub.png)
...
![emlog的404页面](./images/Page_not_found_·_zhengzexin.com.png)
...
![wordpress的404页面](./images/未找到页面___芥子须弥.png)
